...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-gradient-to-t from-background-DEFAULT via-background-light to-background-card text-gray-300 mt-20 overflow-hidden">
      {/* 💫 Animated top glow border */}
      <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-primary via-secondary-DEFAULT to-secondary-accent animate-gradientFlow"></div>
      ...
      <div className="absolute -bottom-40 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-gradient-to-r from-primary/20 via-secondary-DEFAULT/20 to-secondary-accent/20 blur-3xl rounded-full opacity-40 animate-pulse"></div>
    </footer>
  );
};
