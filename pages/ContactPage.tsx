    ...
    <div className="relative text-text-light">
      ...
      <section className="py-20 bg-transparent">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12">
          {/* 🧭 Info Card */}
<div className="space-y-8 bg-[#1b1b22]/80 border border-primary/20 p-10 rounded-2xl shadow-glow backdrop-blur-lg">
      ...
      <div>
        ...
        <p className="text-gray-300 leading-relaxed">
          ...
          <form action="https://formspree.io/f/xgvpvgla" method="POST"
            className="space-y-6 bg-[#1b1b22]/60 border border-primary/20 p-10 rounded-2xl shadow-glow backdrop-blur-md">
